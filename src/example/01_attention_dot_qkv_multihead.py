...
class NumberDataModule(pl.LightningDataModule):
    def __init__(self,
        ...
        input_vocab, output_vocab = self.make_vocab('/home/sin/git/dna/src/example/data/numbers/train.txt')
        ...
        self.all_train_dataset = NumberDataset('/home/sin/git/dna/src/example/data/numbers/train.txt', input_vocab, output_vocab, max_seq_length)
        self.test_dataset = NumberDataset('/home/sin/git/dna/src/example/data/numbers/test.txt', input_vocab, output_vocab, max_seq_length)
...
def cli_main():
    ...
    seq, q, wei, y = iter(dm.train_dataloader()).next()  # <for testing
